						...
						<div class="footer_social">
							<ul class="footbot_social">
								...
								if ( isset( $twtr ) && ! empty( $twtr ) ) :
									?>
								<li><a class="twtr" href="https://twitter.com/<?php echo $twtr; ?>" data-placement="top" data-toggle="tooltip" title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a></li>
									<?php
								endif;
								$gh = get_option( 'github_username' );
								if ( isset( $gh ) && ! empty( $gh ) ) :
									?>
								<li><a class="gh" href="https://github.com/<?php echo $gh; ?>" data-placement="top" data-toggle="tooltip" title="Github" target="_blank"><i class="fa fa-github"></i></a></li>
									<?php
								endif;
								$gl = get_option( 'gitlab_username' );
								if ( isset( $gl ) && ! empty( $gl ) ) :
									?>
								<li><a class="gl" href="https://gitlab.com/<?php echo $gl; ?>" data-placement="top" data-toggle="tooltip" title="Twitter" target="_blank"><i class="fa fa-gitlab"></i></a></li>
									<?php
								endif;
								$fb = get_option( 'facebook_url' );
								if ( isset( $fb ) && ! empty( $fb ) ) :
									?>
								<li><a class="fb" href="<?php echo $fb; ?>" data-placement="top" data-toggle="tooltip" title="Facbook" target="_blank"><i class="fa fa-facebook"></i></a></li>
									<?php
								endif;
								...
								<?php endif; ?>
								<li><a class="rss" href="<?php echo bloginfo( 'rss_url' ); ?>" data-plaecment='top' data-toggle='tooltip' title="Flux RSS"><i class="fa fa-rss"></i></a></li>
							</ul>
						</div>
					</div>
				</div>
