			...
			<section class="content not_found">
							<div class="">
										<div class="page_404">
											...
											<a class="btn btn-default btn-lg back_home btn-wrap" href="<?php echo wp_get_referer() ? wp_get_referer() : get_home_url(); ?>"> <i class="fa fa-arrow-left"></i> Retourner à la page précédente ou l'accueil </a>
										</div>
									</div>
								</section>
			<p><?php esc_html_e( 'Il semble que rien ne se trouve à cet endroit. Peut-être, faut-il essayer une recherche ?', 'micronium' ); ?></p>
			<?php
			koffisani_get_search_form();
			?>
	</div>
<?php get_sidebar(); ?>
<?php
